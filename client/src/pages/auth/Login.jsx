...
import { Mail, Lock, Rocket, Eye, EyeOff, ArrowRight } from 'lucide-react';
      ...
      >
        <div className="glass rounded-3xl p-8 neon-glow">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            New recruit?{' '}
            <Link to="/register" className="text-neon-blue hover:text-neon-blue/80 neon-text font-medium">
              Create account
            </Link>
          </p>
        </div>
